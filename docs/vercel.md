...
После добавления или изменения env нужен redeploy production deployment.
...
## Экономия Vercel deploys

- Не мержить документацию отдельными мелкими PR.
- Складывать docs, чеклисты и шаблоны в один накопительный PR.
- Runtime-фиксы мержить отдельно только при реальном баге.
- Если несколько runtime-фиксов связаны, собирать их в один combined PR.
